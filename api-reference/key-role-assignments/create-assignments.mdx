...
<ParamField body="assignments" type="array" required>
  ...
  <Expandable title="Assignment Object">
    ...
    <ParamField body="entityType" type="string" required>
      Type of entity: `company`, `account`, or `contact`
    </ParamField>
    
    <ParamField body="externalEntityId" type="string">
      External ID of the customer company, account, or contact. Either `entityId` or `externalEntityId` must be provided.
    </ParamField>
...
- Assignments map your internal team members (CSM, AE, etc.) to customer companies, accounts, or contacts
